...
Open Companion and go to the modules page.
Refresh the modules list.
Add the module DEV v1 AT: AT-UC50 or DEV v1 AT: AT-UCIR.
In the Add dialog, set Module Version to Dev version.
After updates to this module, refresh modules and re-open/re-add the module instance so Companion reloads the latest dev build.
